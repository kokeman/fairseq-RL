...
from fairseq import bleu, bert, gleu

from mosestokenizer import MosesDetokenizer

@register_criterion('rl_gleu')
class RLGleuCriterion(FairseqCriterion):
    ...
    def __init__(self, args, task):
        ...
        self.scorer = gleu.SentenceGleu(args)
    ...
    def compute_rl_loss(self, model, net_output, sample, reduce=True):
        ...
        ### rewords ###
        r_hat = torch.tensor([[self.reword(src_i, y_hat_i_n['tokens'], ref_i) for y_hat_i_n in y_hat_i] for src_i, ref_i, y_hat_i in zip(src, ref, y_hat)])
